    ...
    return (
        <div>
                    ...
                    >
                        <Box
                            ...
                            <img
                                ...
                                style={logoStyle} alt="logo of sitemark"
                            />
                        ...
                        <Box sx={{ display: { xs: 'none', md: 'flex' } }}>
                            ...
                            >
                                <Typography variant="body2" color="text.primary">
                                    <Link to="/alldepartments" style={{textDecoration : "none", color : "black"}}>Department</Link>
                                </Typography>
                            </MenuItem>
                            ...
                            >
                                <Typography variant="body2" color="text.primary">
                                    <Link to="/alldoctors" style={{textDecoration : "none", color : "black"}}>Doctors</Link>
                                </Typography>
                            </MenuItem>
                            ...
                            >
                                <Typography variant="body2" color="text.primary">
                                    <Link to="/allblogs" style={{textDecoration : "none", color : "black"}}>Blog</Link>
                                </Typography>
                            </MenuItem>
            ...
            >
                ...
                <MenuItem  onClick={handleCloseUserMenu}>
                  <Typography textAlign="center"> <Link to={`/dashboard/${userId}`} style={{textDecoration : "none", color : "black"}}>Dashboard</Link>
                  </Typography>
                </MenuItem>
                <Divider />
                <MenuItem  onClick={handleCloseUserMenu}>
                  <Typography textAlign="center" onClick={handleLogout}><Link to="/login" style={{textDecoration : "none", color : "black"}}> Logout </Link> </Typography>
                </MenuItem>
